    ...
    <div className="flex h-screen bg-slate-50">
      <aside className="sidebar text-slate-300">
        ...
        >
          {/* Magnetic Hover Pill */}
          <div
            className="absolute left-4 right-4 top-4 h-[44px] bg-gradient-to-r from-emerald-600/20 to-transparent border border-emerald-500/20 rounded-xl transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] z-0 pointer-events-none"
            style={{
